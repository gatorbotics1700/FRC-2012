// Modified version of the FIRST PIDController class

// Created by Stephen and Holly
// 2/20/2012
// PID Controller with feedforward term - primarily used for speed control
 ...
 * PIDOutput
 */
public class SpeedPID implements IUtility{
    ...
    private double m_FF;                // factor for feedforward control
    ...
    private class PIDTask extends TimerTask {
        ...
        private edu.wpi.first.wpilibj.templates.SpeedPID m_controller;

        public PIDTask(edu.wpi.first.wpilibj.templates.SpeedPID controller) {
            if (controller == null) {
     ...
     */
    public SpeedPID(double Kp, double Ki, double Kd, double Kff,
        ...
        m_controlLoop.schedule(new SpeedPID.PIDTask(this), 0L, (long) (m_period * 1000));
    }
    ...
    public SpeedPID(double Kp, double Ki, double Kd, double Kff,
            PIDSource source, PIDOutput output) {
        this(Kp, Ki, Kd, Kff, source, output, kDefaultPeriod);
    }
    ...
    private void calculate() {
        ...
        if (enabled) {
            ...
            synchronized (this) {
                ...
                m_result = (m_P * m_error + m_I * m_totalError + m_D * (m_error - m_prevError) + m_FF*m_setpoint);
                m_prevError = m_error;
     ...
     */
    public synchronized void setGains(double p, double i, double d, double ff) {
        m_P = p;
        m_I = i;
        m_D = d;
        m_FF = ff;
     ...
     */
    public synchronized double getFFW() {
        return m_FF;
    }
